...
#include "ui_normalfromnormal.h"

NormalFromNormal::NormalFromNormal(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::NormalFromNormal)
{
    ui->setupUi(this);
}

NormalFromNormal::~NormalFromNormal()
{
    delete ui;
}

void NormalFromNormal::changeEvent(QEvent *e)
{
