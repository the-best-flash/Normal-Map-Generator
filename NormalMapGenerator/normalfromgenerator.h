...
#ifndef NORMALFROMGENERATOR_H
#define NORMALFROMGENERATOR_H

#include <QWidget>

namespace Ui {
    class NormalFromGenerator;
}

class NormalFromGenerator : public QWidget {
    Q_OBJECT
public:
    NormalFromGenerator(QWidget *parent = 0);
    ~NormalFromGenerator();
...
private:
    Ui::NormalFromGenerator *ui;
};

#endif // NORMALFROMGENERATOR_H
