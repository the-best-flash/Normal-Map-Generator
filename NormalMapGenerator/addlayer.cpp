    ...
    ui(new Ui::AddLayer)
{
    ...
    this->setWindowFlags((this->windowFlags() & ~Qt::WindowContextHelpButtonHint & ~Qt::WindowCloseButtonHint & ~Qt::WindowSystemMenuHint) | Qt::CustomizeWindowHint);
}
...
void AddLayer::changeEvent(QEvent *e)
{
...
void AddLayer::on_Cancel_clicked()
{
    this->hide();
