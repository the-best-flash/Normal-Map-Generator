...
#include "ui_normalfromimage.h"

NormalFromImage::NormalFromImage(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::NormalFromImage)
{
    ui->setupUi(this);
}

NormalFromImage::~NormalFromImage()
{
    delete ui;
}

void NormalFromImage::changeEvent(QEvent *e)
{
