...
#ifndef GENERATESELECTED_H
#define GENERATESELECTED_H
...
class GenerateSelected : public QDialog {
    Q_OBJECT
public:
    GenerateSelected(QWidget *parent = 0);
    ~GenerateSelected();
...
private:
    Ui::GenerateSelected *ui;
};

#endif // GENERATESELECTED_H
