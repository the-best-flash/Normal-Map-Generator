...
#include "ui_normalfromgenerator.h"

NormalFromGenerator::NormalFromGenerator(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::NormalFromGenerator)
{
    ui->setupUi(this);
}

NormalFromGenerator::~NormalFromGenerator()
{
    delete ui;
}

void NormalFromGenerator::changeEvent(QEvent *e)
{
