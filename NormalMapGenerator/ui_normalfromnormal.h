/********************************************************************************
** Form generated from reading UI file 'normalfromnormal.ui'
**
...
#ifndef UI_NORMALFROMNORMAL_H
#define UI_NORMALFROMNORMAL_H
...
public:
    ...
    void setupUi(QWidget *NormalFromNormal)
    {
        if (NormalFromNormal->objectName().isEmpty())
            NormalFromNormal->setObjectName(QString::fromUtf8("NormalFromNormal"));
        NormalFromNormal->resize(400, 338);
        verticalLayout_2 = new QVBoxLayout(NormalFromNormal);
        verticalLayout_2->setContentsMargins(1, 1, 1, 1);
        verticalLayout_2->setObjectName(QString::fromUtf8("verticalLayout_2"));
        groupBox = new QGroupBox(NormalFromNormal);
        ...
        sizePolicy.setHeightForWidth(ImageName->sizePolicy().hasHeightForWidth());
        ImageName->setSizePolicy(sizePolicy);
        ...
        retranslateUi(NormalFromNormal);

        QMetaObject::connectSlotsByName(NormalFromNormal);
    } // setupUi

    void retranslateUi(QWidget *NormalFromNormal)
    {
        NormalFromNormal->setWindowTitle(QApplication::translate("NormalFromNormal", "Form", 0, QApplication::UnicodeUTF8));
        groupBox->setTitle(QApplication::translate("NormalFromNormal", "Layer Settings", 0, QApplication::UnicodeUTF8));
        label_3->setText(QApplication::translate("NormalFromNormal", "Layer\n"
"Name", 0, QApplication::UnicodeUTF8));
        groupBox_4->setTitle(QApplication::translate("NormalFromNormal", "Blend Settings", 0, QApplication::UnicodeUTF8));
        label_4->setText(QApplication::translate("NormalFromNormal", "Mode:", 0, QApplication::UnicodeUTF8));
        BlendMode->clear();
        BlendMode->insertItems(0, QStringList()
         << QApplication::translate("NormalFromNormal", "Additive", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("NormalFromNormal", "Overlay", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("NormalFromNormal", "Multiply", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("NormalFromNormal", "Normal", 0, QApplication::UnicodeUTF8)
        );
        Invert->setText(QApplication::translate("NormalFromNormal", "Invert Before Blend", 0, QApplication::UnicodeUTF8));
        groupBox_3->setTitle(QApplication::translate("NormalFromNormal", "Layer Settings", 0, QApplication::UnicodeUTF8));
        label_2->setText(QApplication::translate("NormalFromNormal", "Intensity", 0, QApplication::UnicodeUTF8));
        LoadImage->setText(QApplication::translate("NormalFromNormal", "...", 0, QApplication::UnicodeUTF8));
        label_5->setText(QApplication::translate("NormalFromNormal", "Image", 0, QApplication::UnicodeUTF8));
    } // retranslateUi

};

namespace Ui {
    class NormalFromNormal: public Ui_NormalFromNormal {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_NORMALFROMNORMAL_H
